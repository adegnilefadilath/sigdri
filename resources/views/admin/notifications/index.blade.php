...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">
            Déclarations soumises, agréments expirants et alertes système
        </p>
    </div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    {{-- Couleurs et libellés selon le type --}}
    @php
        $config = match($notif->type) {
            'declaration_soumise'  => ['badge_bg' => 'bg-blue-100',   'badge_text' => 'text-blue-700',   'label' => 'Déclaration soumise'],
            'declaration_validee'  => ['badge_bg' => 'bg-green-100',  'badge_text' => 'text-green-700',  'label' => 'Déclaration validée'],
            'declaration_rejetee'  => ['badge_bg' => 'bg-red-100',    'badge_text' => 'text-red-700',    'label' => 'Déclaration rejetée'],
            'agrement_expirant'    => ['badge_bg' => 'bg-amber-100',  'badge_text' => 'text-amber-700',  'label' => 'Agrément expirant'],
            'agrement_expire'      => ['badge_bg' => 'bg-orange-100', 'badge_text' => 'text-orange-700', 'label' => 'Agrément expiré'],
            default                => ['badge_bg' => 'bg-gray-100',   'badge_text' => 'text-gray-600',   'label' => 'Système'],
        };
    @endphp
    ...
    <div class="flex items-start gap-4 px-5 py-4 border-b border-gray-100 last:border-0
        ...
        @if (! $notif->lu)
        <form method="POST" action="{{ route('admin.notifications.lue', $notif->id) }}" class="shrink-0 mt-1">
            @csrf
            <button type="submit"
    ...
    <div class="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p class="text-sm text-gray-400">
            Vous serez notifié ici lors de nouvelles déclarations soumises ou d'alertes sur les agréments.
        </p>
    </div>
