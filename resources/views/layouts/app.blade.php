...
<head>
    ...
    {{-- Slot pour les feuilles de style spécifiques à certaines pages (ex : Leaflet) --}}
    @stack('styles')
</head>
    ...
    <aside class="w-64 shrink-0 flex flex-col overflow-hidden" style="background-color: #1a237e;">
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-0.5">
            ...
            <a href="{{ route('admin.reporting.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                      {{ request()->routeIs('admin.reporting.*') ? 'text-white shadow-md' : 'hover:bg-white/10' }}"
               style="{{ request()->routeIs('admin.reporting.*') ? 'background-color: #F97316;' : 'color: rgba(255,255,255,0.75);' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- Cartographie --}}
            <a href="{{ route('admin.cartographie.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                      {{ request()->routeIs('admin.cartographie.*') ? 'text-white shadow-md' : 'hover:bg-white/10' }}"
               style="{{ request()->routeIs('admin.cartographie.*') ? 'background-color: #F97316;' : 'color: rgba(255,255,255,0.75);' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.alertes.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                      {{ request()->routeIs('admin.alertes.*') ? 'text-white shadow-md' : 'hover:bg-white/10' }}"
               style="{{ request()->routeIs('admin.alertes.*') ? 'background-color: #F97316;' : 'color: rgba(255,255,255,0.75);' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.journaux.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                      {{ request()->routeIs('admin.journaux.*') ? 'text-white shadow-md' : 'hover:bg-white/10' }}"
               style="{{ request()->routeIs('admin.journaux.*') ? 'background-color: #F97316;' : 'color: rgba(255,255,255,0.75);' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.utilisateurs.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                      {{ request()->routeIs('admin.utilisateurs.*') ? 'text-white shadow-md' : 'hover:bg-white/10' }}"
               style="{{ request()->routeIs('admin.utilisateurs.*') ? 'background-color: #F97316;' : 'color: rgba(255,255,255,0.75);' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.parametres.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                      {{ request()->routeIs('admin.parametres.*') ? 'text-white shadow-md' : 'hover:bg-white/10' }}"
               style="{{ request()->routeIs('admin.parametres.*') ? 'background-color: #F97316;' : 'color: rgba(255,255,255,0.75);' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ ouvert: false }" @click.outside="ouvert = false">
                        ...
                        <div id="dropdown-user"
                            ...
                            <a href="{{ route('admin.profil.index') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
